        ...
        this.zoneDensities = asciis.map(function(ascii) {
            var zone = ascii.map(function(row) {
                var densities = row.split('').map(function(gray) {
                    ...
                    greyObj[tripleBar] = 768;
                    var greyRet = greyObj[gray];
                    return greyRet;
                });
                return densities;
            });
    ...
    */
    var OCR_ZON = [
        ...
        new bbs.OCRChar(['  =####=  ',
                ...
                '   -#=    ',
                '  ' + tripleBar + '-      ',
                '=#' + tripleBar + '' + tripleBar + '' + tripleBar + '' + tripleBar + '' + tripleBar + '' + tripleBar + '' + tripleBar + '' + tripleBar + '',
                '' + tripleBar + '#########'
            ],
            ...
            ['  ######  ',
                ...
                '  -####   ',
                ' =####    ',
                '=####' + tripleBar + '' + tripleBar + '' + tripleBar + '' + tripleBar + '-',
                '#########='
            ],
    ...
    var OCR_RATIOS = [46, 64, 64, 66, 64, 66, 60, 66, 66];
    ...
    bbs.SudBitmap = function(config) {
        ...
        /////////////////////////////////////////////////////////////////////////
        function monochrome() {
            var C = 15; //2;	// it is better 1 in some cases
            var RECT = Math.round(_w / 20); //5;	// TODO dynamically adapt value from 3 to 8 based on image size
            var count = (RECT * 2 + 1) * (RECT * 2 + 1);
        ...
        function detectRect(theta) {
            ...
            var SampleOffset = (SAMPLE_LEN - 1) / 2,
