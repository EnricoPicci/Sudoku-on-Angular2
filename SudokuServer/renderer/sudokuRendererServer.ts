...
export class SudokuRendererServer {
    private static singleton = new SudokuRendererServer();
    ...
    public static renderBoardImage(inImage: any, req, res) {
        return this.singleton.renderImage(inImage, req, res);
    }
    
    public renderImage(inImage: any, req, res) {
